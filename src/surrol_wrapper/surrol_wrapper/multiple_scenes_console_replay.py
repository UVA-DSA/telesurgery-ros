...
class SurgicalSimulator(SurgicalSimulatorBase):
    ...
    def load_policy(self, obs, env):
        steps = str(300000)
        if self.id == 8:
            model_file = '../telesurgery_qos_analysis/SurRoL_dVTrainer/tests/peg_transfer_model'
        if self.id == 6:
            model_file = '../telesurgery_qos_analysis/SurRoL_dVTrainer/tests/needle_pick_model'
